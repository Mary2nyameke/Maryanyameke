...
using namespace std;
int main()
{ int edStaffL=0,stdMenu=0,editS,editS1,p=0,m,mm=0,h=0,e,del,z=0,x=0, i=0,j=0,t=0,c=0,cNo[10],print,addStaff=0,v0=0,v=0, eSLoop=0;
...
for( t=0;t<cNo[i-1];t++)
cout<<k.courses[r][i-1]<<"                                                    \t            "<<k.credit[t][i-1]<<"  \t   "<<k.gpa[t][i-1]<<"  \t   "<<k.gpt[t][i-1]<<endl;
...
cout<<"COURSE                                                                     CREDIT     GRADE        GPT                     \n";
for( t=0;t<cNo[i-1];t++)
cout<<k.courses[r][print-1]<<"                                                    \t            "<<k.credit[t][print-1]<<"  \t   "<<k.gpa[t][print-1]<<"  \t   "<<k.gpt[r][print-1]<<endl;
     cout<<"Enter any key to return to student menu\n";
     cin>>stdToMain;
     system("cls");
     break;
